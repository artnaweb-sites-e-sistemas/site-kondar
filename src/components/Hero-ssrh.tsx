            ...
            <div className="relative bg-white rounded-xl shadow-soft p-6 md:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary mb-1">Configuração Personalizada</h3>
                    <p className="text-primary-light text-sm">Treinamos sua IA com informações específicas do seu negócio</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary mb-1">Atendimento 24/7</h3>
                    <p className="text-primary-light text-sm">Seus clientes são atendidos a qualquer hora, todos os dias</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-primary mb-1">Integração Completa</h3>
                    <p className="text-primary-light text-sm">Conectamos com seus sistemas existentes</p>
                  </div>
                </div>
              </div>
            </div>
